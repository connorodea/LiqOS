...
const NAV_MODULES = [
  ...
  { label: "Testing & Grading", href: "/inventory", icon: ClipboardCheck },
  { label: "Manifests", href: "/manifests", icon: FileSpreadsheet },
  { label: "Lot Builder", href: "/lots", icon: Boxes },
  { label: "Listings", href: "/listings", icon: ShoppingCart },
  { label: "Orders", href: "/orders", icon: Package },
  { label: "Shipping", href: "/shipments", icon: Truck },
  { label: "Returns", href: "/returns", icon: RotateCcw },
  { label: "Refurbishment", href: "/refurbishment", icon: Wrench },
  { label: "Photos", href: "/photos", icon: Camera },
  { label: "Labels", href: "/labels", icon: Tags },
  { label: "Analytics", href: "/analytics", icon: BarChart3 },
  { label: "Users & Roles", href: "/users", icon: Users },
  { label: "API", href: "/api", icon: Plug },
